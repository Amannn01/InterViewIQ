...
function Pricing() {
  ...
  const handlePayment = async (plan) => {
    try {
      ...
      const result = await axiosInstance.post(ServerUrl + "/api/payment/order" , {
        planId: plan.id,
        amount: amount,
      ...
      handler:async function (response) {
        const verifypay = await axiosInstance.post(ServerUrl + "/api/payment/verify" ,response , {withCredentials:true})
